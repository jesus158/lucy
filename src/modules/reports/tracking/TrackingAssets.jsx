...
class TrackingAssets extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            openAlertInfo: false,
    ...
    render = () => {
        ...
        if (apiPaginationAsset === undefined) {
            apiPaginationAsset = {};
        }
                ...
                <Card key={`CardTracking`} >
                    ...
                    <CardBody style={{ overflow: "auto" }}>
                        ...
                        <TablePagination
                            ...
                            pages={apiPaginationAsset.totalPages}
                            rowsPerPage={apiPaginationAsset.limit}
                            page={apiPaginationAsset.currentPage}
