...
import { configureGateway, getGatewayById, setGateway } from 'modules/gateway/GatewayActions.js';
...
class GatewayAdmin extends React.Component {
  ...
  componentDidMount = () => {
    ...
    if (urlParams.has('code')) {
      this.props.getGatewayById(urlParams.get('code'));
    }
  }
  ...
  configureGateway = () => {
    ...
    this.props.configureGateway(typeService, this.props, (success) => {
  ...
  handleInputText = event => {
    ...
    this.props.setGateway(typeService);
  };
          ...
          <CardBody>
            <GridContainer>
              ...
              <GridItem xs={12} sm={12} className={classes.gridItem}>
                ...
                <Button onClick={this.configureGateway} color="success">
                  Guardar
                    </Button>
...
const mapDispatchToProps = dispatch => {
  return {
    configureGateway: (typeService, ownProps, onSuccess) => dispatch(configureGateway(typeService, ownProps, onSuccess)),
    setGateway: (typeService) => dispatch(setGateway(typeService)),
    getGatewayById: (id) => dispatch(getGatewayById(id)),
  };
};

export default withStyles(style)(connect(mapStateToProps, mapDispatchToProps)(GatewayAdmin));