...
class ApiClient {
  ...
  getCarrierBehavior = (beginDate,
    ...
    if (listIdCarrier !== undefined) {
        uriFilter += "&listIdCarrier=" + listIdCarrier;
    }

    let request = {
      method: "get",
      url:
        `${this.url}/reports/getCarrierBehavior/${this.account}/` + encodeURI(uriFilter),
      headers: {
